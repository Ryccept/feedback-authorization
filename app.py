...
def register_user():
    """Shows register form for user if get and handles registeration data if a post. Adds to DB too."""
    form = RegisterForm()
...
def login_form():
    """Shows login form for user if get and handles login data if a post."""
    form = LoginForm()
...
# def register_page():
#     """Secret route. Only visible if user is logged in"""
